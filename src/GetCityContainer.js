...
GetCityContainer.propTypes = {direction: PropTypes.string}
GetCityContainer.contextTypes = {router: PropTypes.object.isRequired};
GetCityContainer.defaultProps = {direction: "column"};
