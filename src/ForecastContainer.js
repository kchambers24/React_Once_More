...
class ForecastContainer extends Component {
  ...
  componentDidMount() {
    ...
    getForcast(this.state.city).then(function(response) {
      self.setState({isLoading: false, forecastData: response})
    })
  }
  ...
  render() {
    return (<Forecast city={this.props.routeParams.city} isLoading={this.state.isLoading} forecastData={this.state.forecastData}/>);
  }
}
